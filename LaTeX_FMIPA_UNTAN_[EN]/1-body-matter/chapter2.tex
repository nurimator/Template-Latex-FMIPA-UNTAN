...
The line spacing from the chapter title to the section is 3 lines. The distance from the section to the first sentence is 1.5 lines.

\subsection{Subsection}
If a subsection is required, it is typed using an underline but not in bold. The numbering follows the section such as 2.1.1; 2.1.2; 2.1.3; etc.

\subsection{Subsection}
Example of other subsection usage.
