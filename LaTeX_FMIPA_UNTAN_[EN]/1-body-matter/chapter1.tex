...
\section{Background}
The background reflects a dynamic flow of thought, explaining why a phenomenon (natural or social) encountered can trigger the intention or call to conduct research \parencite{dewi2022}. In this regard, the researcher must feel confident that the phenomenon encountered is still an actual and relevant problem with current conditions [cite: 250]. This can be obtained by seeking information from the latest literature or consulting with scientific experts related to the discipline concerned [cite: 251].
...
This sub-chapter is a sharpening of the specification of the contribution of research results to practical benefits, as well as its scientific contribution to the development of science.
